...
public class UserController {
	...
	public String createUser(@Validated(FormValidationGroup.class) User user, BindingResult result) {
		...
		public String createReserveBook(Reserve reserve, BindingResult result, Principal principal) {
	...
	public String getReserveBook(Reserve reserve,Model model, Principal principal)
		{
